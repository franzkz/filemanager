...
<meta name="description" content="Файловый менеджер" />
<meta name="keywords" content="Файловый менеджер" />
...
{% if err %}
<div style="color: red; background-color: white; padding: 10px 4px; width: 200px; margin: 0 auto">Доступ закрыт!</div>
{% endif %}

<div id="dl">
<span class="legend">Авторизация</span>
