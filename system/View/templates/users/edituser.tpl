...
<div class="form-inline">
    <label class='radio'><input name='priv' value="admin" type='radio' {% if post.priv == "admin" %} checked {% endif %} />&nbsp;<b>Администратор</b></label>
    <label class='radio'><input name='priv' value="null" type='radio' {% if post.priv == FALSE  %} checked {% endif %} />&nbsp;<b>Пользователь</b></label>
</div>
...
<div class="form-inline">
<b>Объем доступный для загрузки</b>&nbsp;
