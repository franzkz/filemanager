...
Имя новой группы:&nbsp;<input type="text" id="name" name="name" style="width: 150px; margin-right: 20px" />
...
<div title="Редактировать" id="editCat" style="display: none">
...
function delCat(id) {
    $('<div title="Удалить">Вы действительно хотите удалить?<div>').dialog({
		modal: true,
	    buttons: {
            "Yes": function() {
                delCatOK(id);
